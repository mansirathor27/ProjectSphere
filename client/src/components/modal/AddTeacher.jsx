...
const AddTeacher = () => {
  ...
  const handleCreateTeacher = (e)=>{
    ...
    setFormData({
      name: "", email: "",
    department: "",
    password: "", experties: "", maxStudents: 1
    });
      ...
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                  <div className="bg-white rounded-lg p-6 w-full max-w-md mx-4">
                    <div className="flex justify-between items-center mb-4">
                      ...
                      <button onClick={()=> dispatch(toggleTeacherModal())} className="text-slate-400 hover:to-slate-600">
                        <X className="w-6 h-6"/>
                      </button>
                    </div>
                    ...
                    <form onSubmit={handleCreateTeacher} className="space-y-4">
                      ...
                      <div>
                        ...
                        <input type="password" required value={formData.password} onChange={(e)=>
                  ...
                  className="input-field w-full py-1 border-b border-slate-600 focus:outline-none"
                   />
                      ...
                      <div className="flex justify-end space-x-3 pt-4">
                        <button type="button" onClick={()=> dispatch(toggleTeacherModal())}
